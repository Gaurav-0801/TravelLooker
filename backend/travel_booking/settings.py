...
DEBUG = config("DEBUG", default=False, cast=bool)  # Default False in prod

# ✅ ALLOWED_HOSTS
# Explicitly list your backend domain (Render)
ALLOWED_HOSTS = [
    "travellooker.onrender.com",  # backend production
    "localhost",
    "127.0.0.1"
]
